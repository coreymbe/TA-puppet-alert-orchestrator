...
#
#
# Configure the AOB Helper (Setup_Utiil) to access the settings configured in the add-on.
    ...
    try:
      ...
      for task in tasklist:
        ...
        try:
          ...
          sys.stderr.write("TA-puppet-alert-actions: Unable to determine task parameters - {}".format(e))
      ...
      for plan in planlist:
        ...
        try:
          ...
          sys.stderr.write("TA-puppet-alert-actions: Unable to determine plan parameters - {}".format(e))
    except Exception as e:
